// 本文件由 scripts/gen-fallback.js 从 src/data/cleanup-rules.json 自动生成（审查 2-2）。
          ...
          "items": [
            {
              ...
              "name": "Windows下载缓存",
              "risk": "medium",
              "pathPs": "$env:WINDIR + '\\SoftwareDistribution\\Download'",
            ...
            },
            {
              ...
              "name": "缩略图缓存(需重启explorer)",
              "risk": "low",
              "pathPs": "$env:LOCALAPPDATA + '\\Microsoft\\Windows\\Explorer'",
              "fileKeys": [
                {
